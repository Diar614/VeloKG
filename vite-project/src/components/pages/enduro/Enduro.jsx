...
const slides = [
  ...
  },
  {
    ...
    text: "Лучшие велосипеды с толстыми шинами прочные, долговечные и имеют огромный дорожный просвет. Если вы посмотрите на велосипед с толстыми шинами, то увидите, что он довольно простой. Обычно он жёсткий (то есть у него нет подвески), у него дисковые тормоза и толстые шины.",
  ...
  },
  {
    ...
    text: "Езда по пересечённой местности (также часто называемая кросс-кантри) предполагает быструю езду везде, а не только вниз по склону. В отличие от эндуро или скоростного спуска, езда по пересечённой местности предполагает быструю езду на подъёмах, по равнине и вниз по склону.",
  ...
  },
  {
    ...
    text: "Горные велосипеды для трейла универсальны, и хороший велосипед с полной подвеской может делать всё понемногу: подниматься, спускаться и ехать по узким извилистым однопутным дорогам.",
  ...
  },
  {
    ...
    text: "Эндуро-велосипеды являются популярным вариантом для гонщиков, которые хотят спускаться по крутым трассам, но при этом иметь возможность эффективно подниматься в гору и преодолевать крутые участки.",
    ...
    <div>
      ...
      >
        ...
        <p className="text-xl sm:text-lg md:text-xl leading-relaxed max-w-4xl mx-auto pt-5 pr-24">
          Эндуро-катание на горных велосипедах уходит корнями в гонки на эндуро. В гонках на эндуро гонщики соревнуются на определённых участках (обычно на спусках), но должны перемещаться между ними. Таким образом, эндуро-катание на горных велосипедах в некоторых аспектах похоже на катание на горных велосипедах. Велосипеды сконструированы так, чтобы обеспечить безумную скорость при спуске. Однако, эндуро-велосипеды отличаются от велосипедов для катания на горных велосипедах или тем, что они немного более универсальны. Они очень хорошо взбираются на холмы, несмотря на свою массивность.
        </p>
      </motion.div>
      ...
      >
        ...
        <p className="text-xl sm:text-lg md:text-xl leading-relaxed max-w-4xl mx-auto pt-5">
          Если вам действительно не терпится как можно быстрее промчаться по крутым, труднопроходимым тропам, купите велосипед для эндуро. Вы по-прежнему сможете погонять с друзьями на <Link to="/freerideBike" className="underline pl-2 cursor-pointer hover:text-blue-700">фрирайд-велосипедах</Link>, но вы будете в восторге от спусков и труднопроходимых участков тропы. Конечно, на подъёмах вам придётся немного тяжелее, так что если для вас важны мастерство в подъёмах и сохранение темпа на равнинных участках, то выбирайте трейл-байк. Но если вам нравится спускаться с горы как можно быстрее, выбирайте эндуро.
        </p>
      </motion.div>
